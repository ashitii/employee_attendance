...
SECRET_KEY = 'django-insecure-8zb32o2g*rh(7-i+s7+3ipps68el=l-ip21&%po_satpv36kap'
...
ASGI_APPLICATION = 'employee_attendance.asgi.application'
CHANNEL_LAYERS = {
    'default': {
...
TEMPLATES[0]['DIRS'] = [
    ...
    os.path.join(BASE_DIR, 'chatting', 'templates'),
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'helidhanani3@gmail.com'
EMAIL_HOST_PASSWORD = 'hvwm qjkf bfuv pkon'  # App password, not Gmail login
